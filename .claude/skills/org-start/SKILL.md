...
- `--permission-mode {mode}`: registry/org-config.md の default_permission_mode の値を使用

### フォアマン
```
claude --dangerously-load-development-channels server:claude-peers --permission-mode {default_permission_mode} --model opus
```
