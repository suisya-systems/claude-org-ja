...
profile の正本は claude-org-ja repo 配下 (`docs/sandbox-probe/profiles/profile-baseline.json`) に取り込み済。元 spike worker (`/home/$USER/work/org/workers/sandbox-probe/`) を持っていない環境でもここから cp する。
