...
| スキル | 用途 |
|---|---|
| `/secretary-handover` | 窓口の進行中ワーク・組織状態を `.state/secretary-handover.md` に書き出す（ディスパッチャー・キュレーター・ワーカーのペインは生かしたまま） |
